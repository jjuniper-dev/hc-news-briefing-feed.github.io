# Agent Skills Compendium (Platform-Neutral Reference)

This document is a **platform-neutral reference** that expands the major categories from the DataCamp article on 100+ agent skills.
It is intended as a reusable taxonomy for agent platforms and is **not tied to any specific repository, product deployment, or CI pipeline**.
...
## Installation snippets (examples only)
...
## Example `SKILLS.md` manifest (starter)
...
- Adapt installer commands to your own environment and repository conventions.
- Keep this document in a docs/knowledge location if you do not want it interpreted as product-specific implementation guidance.
